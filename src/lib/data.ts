...
export const DEFAULT_PAGE_SETTINGS = {
  ...
  quickLinks: [
    { id: '1', title: 'Illuminazione LED', subtitle: 'Efficienza e design', color: 'bg-brand-blue', category: 'Illuminazione' },
    { id: '2', title: 'Sicurezza Smart', subtitle: 'Proteggi la tua casa', color: 'bg-indigo-600', category: 'Sicurezza' },
    { id: '3', title: 'Bricolage', subtitle: 'Tutto per il fai da te', color: 'bg-brand-yellow', category: 'Bricolage' },
  ] as any[],
  linkRapidi: [
    { id: '1', title: 'Illuminazione LED', subtitle: 'Efficienza e design', color: 'bg-brand-blue', category: 'Illuminazione' },
    { id: '2', title: 'Sicurezza Smart', subtitle: 'Proteggi la tua casa', color: 'bg-indigo-600', category: 'Sicurezza' },
  ...
  homeSlides: [
    { id: 'h1', url: 'https://picsum.photos/seed/hero1/1920/1080', title: 'Benvenuti in BesPoint', alt: 'La migliore tecnologia per la tua casa', position: 'home_top' },
    { id: 'h2', url: 'https://picsum.photos/seed/hero2/1920/1080', title: 'Offerte Primaverili', alt: 'Sconti fino al 40% su illuminazione', position: 'home_top' },
  ] as any[],
  categoryBanners: {} as Record<string, any>,
  categorySeo: {} as Record<string, any>,
  maxFeatured: 8,
  maxNewArrivals: 15,
  specialCategoryMax: 4,
  topBarMode: 'static' as 'static' | 'marquee' | 'image',
